...
textSize(20)
fill ("blue")
text ("Read these instructions carefully,These are the instruction for the game:",displayWidth/4-20,displayHeight/4)
text("The player can move using the arrow keys and the button 1 will eqip you with a gun to widraw the gun press 2",displayWidth/3-15,displayHeight/3+20)
// start.mousePressed({
//   start.hide();
//   fullgamestate=2;
...
//position button
reload.position(displayWidth/2,displayHeight/2);
reload.size(50,50);
// mousePressed event
reload.mousePressed(
  function(){
